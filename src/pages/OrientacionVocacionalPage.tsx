    ...
    <>
      ...
      <div className="relative h-80 md:h-96 overflow-hidden bg-gradient-to-br from-[#10323F] to-[#2E136E]">
        ...
        >
          ...
          <p className="text-sm md:text-base text-[#00AFF0]">Descubre tu carrera ideal</p>
        </motion.div>
      </div>
              ...
              >
                ...
                <div className="mb-12">
                  <div className="flex justify-between mb-4">
                    <span className="text-sm font-semibold text-gray-700">Pregunta {currentQuestion + 1} de {questions.length}</span>
                    <span className="text-sm font-semibold text-[#00AFF0]">{Math.round(((currentQuestion + 1) / questions.length) * 100)}%</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                    <motion.div
                      ...
                      transition={{ duration: 0.5 }}
                      className="bg-gradient-to-r from-[#00AFF0] to-[#572364] h-full rounded-full"
                    ></motion.div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    {questions[currentQuestion].answers.map((answer, index) => (
                      <motion.button
                        ...
                        className="w-full p-6 bg-gradient-to-r from-gray-50 to-gray-100 border-2 border-gray-200 rounded-xl text-left font-semibold text-gray-800 hover:border-[#00AFF0] hover:bg-[#00AFF0]/10 transition-all duration-300"
                      >
                        {answer.text}
                      </motion.button>
                    ))}
              ...
              >
                ...
                <div className="text-center mb-12">
                  <motion.div
                    ...
                    className="w-24 h-24 bg-gradient-to-br from-[#00AFF0] to-[#572364] rounded-full flex items-center justify-center text-white text-5xl font-bold mx-auto mb-6"
                  >
                    <FaCheckCircle />
                  </motion.div>

                  <h2 className="text-4xl font-bold text-gray-800 mb-4">¡Listo!</h2>
                ...
                {topCareerData && (
                  <motion.div
                    ...
                    className="bg-gradient-to-br from-[#00AFF0]/10 to-[#572364]/10 border-2 border-[#00AFF0]/40 rounded-xl p-12 mb-12 text-center"
                  >
                    <h3 className="text-3xl font-bold gradient-text mb-4">{topCareerData.title}</h3>
                    <p className="text-gray-700 mb-6 text-lg">{topCareerData.description}</p>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                      <div>
                        <p className="text-gray-600 font-semibold">Duración</p>
                        <p className="text-2xl text-[#00AFF0] font-bold">{topCareerData.duration}</p>
                      </div>
                      <div>
                        <p className="text-gray-600 font-semibold">Modalidad</p>
                        <p className="text-2xl text-[#00AFF0] font-bold">{topCareerData.modality}</p>
                      </div>
                    </div>
                    ...
                    <Link to={`/carreras/${topCareerData.slug}`}>
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="px-8 py-3 bg-gradient-to-r from-[#00AFF0] to-[#572364] text-white font-bold rounded-full flex items-center gap-2 justify-center hover:shadow-lg transition-all duration-300 mx-auto mb-4"
                      >
                ...
                <motion.div
                  ...
                  className="mb-12"
                >
                  <h4 className="text-2xl font-bold text-gray-800 mb-6">También te podrían interesar:</h4>
                        ...
                        return career ? (
                          <Link key={slug} to={`/carreras/${slug}`}>
                            <motion.div
                              ...
                              className="bg-white border-2 border-gray-200 rounded-lg p-4 hover:border-[#00AFF0]/40 transition-all cursor-pointer"
                            >
                              <h5 className="font-bold text-gray-800 mb-2">{career.title}</h5>
                              <div className="flex items-center gap-2 text-[#00AFF0] font-semibold text-sm">
                                Explorar <FaLink />
                              </div>
                            </motion.div>
                          </Link>
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-r from-[#00AFF0] to-[#10323F] rounded-xl p-8 text-white text-center mb-8"
                >
                  ...
                  <a href="/#contacto">
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="px-6 py-2 bg-white text-[#00AFF0] font-bold rounded-full hover:shadow-lg transition-all duration-300"
                    >
                ...
                <div className="text-center">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={resetQuiz}
                    className="px-8 py-3 border-2 border-gray-400 text-gray-700 font-bold rounded-full hover:border-gray-600 transition-all duration-300"
                  >
