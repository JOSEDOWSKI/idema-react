    ...
    <>
      ...
      <div className="relative h-96 md:h-[500px] overflow-hidden bg-gradient-to-br from-[#10323F] to-[#2E136E]">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-[#00AFF0] max-w-2xl">Oportunidad de crecimiento empresarial con modelo educativo probado</p>
        </motion.div>
      </div>
      ...
      <div className="bg-white py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {benefits.map((benefit, index) => (
                ...
                >
                  <benefit.icon className="text-4xl text-[#00AFF0] mb-4" />
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="mb-20 bg-gradient-to-br from-[#00AFF0]/10 to-[#572364]/10 p-12 rounded-xl border-2 border-[#00AFF0]/30"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {requirements.map((requirement, index) => (
                ...
                >
                  <FaCheckCircle className="text-[#00AFF0] text-2xl mt-1 flex-shrink-0" />
              ...
              {steps.map((step, index) => (
                ...
                >
                  <div className="bg-white border-2 border-gray-200 rounded-lg p-8 h-full">
                    <div className="absolute -top-5 -left-5 w-14 h-14 bg-gradient-to-br from-[#00AFF0] to-[#572364] text-white font-bold text-2xl rounded-full flex items-center justify-center shadow-lg">
                      {step.number}
                    </div>
