    ...
    <>
      ...
      <div className="relative h-96 md:h-[500px] overflow-hidden">
        ...
        >
          ...
          {carrera.subtitle && <p className="text-cyan-300 text-lg mb-2">{carrera.subtitle}</p>}
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          ...
          {prices.length > 0 && (
            ...
            >
              ...
              {carrera.matricula && (
                <p className="text-gray-600 mb-6">Matrícula: <span className="font-bold text-cyan-600">{carrera.matricula}</span></p>
              )}
