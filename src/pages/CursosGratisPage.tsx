      ...
      <div className="bg-white py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          ...
          >
            ...
            >
              <FaCertificate className="text-4xl text-purple-600 mb-4" />
              <h3 className="text-xl font-bold text-gray-800 mb-3">Certificado Incluido</h3>
              <p className="text-gray-700">Recibe un certificado al completar el curso exitosamente.</p>
            </motion.div>

            <motion.div
              whileHover={{ translateY: -10 }}
              className="bg-gradient-to-br from-orange-50 to-yellow-50 p-8 rounded-xl border-2 border-orange-200"
            >
              <FaUsers className="text-4xl text-orange-600 mb-4" />
              <h3 className="text-xl font-bold text-gray-800 mb-3">Comunidad Activa</h3>
              <p className="text-gray-700">Interactúa con instructores y compañeros de aprendizaje.</p>
            </motion.div>
          </motion.div>
