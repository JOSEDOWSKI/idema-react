    ...
    <>
      ...
      <div className="bg-gray-50 py-4 px-6 md:px-12">
        <div className="max-w-6xl mx-auto flex items-center gap-2 text-sm text-gray-600">
          ...
          <span>/</span>
          <Link to="/#especializaciones" className="hover:text-[#00AFF0]">Especializaciones</Link>
          <span>/</span>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          ...
          {prices.length > 0 && (
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16">
              ...
              {especializacion.matricula && <p className="text-gray-600 mb-6">Matrícula: <span className="font-bold text-[#00AFF0]">{especializacion.matricula}</span></p>}
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <motion.div whileHover={{ translateY: -10 }} className="bg-gradient-to-br from-[#00AFF0]/10 to-[#572364]/10 p-6 rounded-xl border border-[#00AFF0]/30">
                <FaClock className="text-[#00AFF0] text-3xl mb-4" /><h3 className="font-bold text-gray-800 mb-2">Duración</h3><p className="text-gray-700">{especializacion.duration}</p>
              </motion.div>
              <motion.div whileHover={{ translateY: -10 }} className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 rounded-xl border border-blue-200">
                <FaBook className="text-[#572364] text-3xl mb-4" /><h3 className="font-bold text-gray-800 mb-2">Modalidad</h3><p className="text-gray-700">{especializacion.modality}</p>
              </motion.div>
